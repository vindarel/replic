...
Available commands
==================
highlight  ... Highlight the given words (for this session).
help       ... Print the help of all available commands.
reload     ... NIL
set        ... Change this variable.
unhighlight... Un-highlight the given words.
...
If you want to have the base commands (=help=, =reload=, =set=, =quit=,
